...
static void DeallocCallback(void *ref) {
    GGGTextRunDelegate *self = (__bridge_transfer GGGTextRunDelegate *)(ref);
    self = nil; // release
}

static CGFloat GetAscentCallback(void *ref) {
    GGGTextRunDelegate *self = (__bridge GGGTextRunDelegate *)(ref);
    return self.ascent;
}
...
@implementation GGGTextRunDelegate
