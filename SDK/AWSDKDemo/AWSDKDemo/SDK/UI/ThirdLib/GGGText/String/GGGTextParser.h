...
/**
 The GGGTextParser protocol declares the required method for GGGTextView and GGGLabel
 to modify the text during editing.
 
 You can implement this protocol to add code highlighting or emoticon replacement for
 GGGTextView and GGGLabel. See `GGGTextSimpleMarkdownParser` and `GGGTextSimpleEmoticonParser` for example.
 */
@protocol GGGTextParser <NSObject>
@required
/**
 When text is changed in GGGTextView or GGGLabel, this method will be called.
 ...
 no selected range (such as GGGLabel), this value is NULL.
 ...
 */
@interface GGGTextSimpleMarkdownParser : NSObject <GGGTextParser>
 ...
 */
@interface GGGTextSimpleEmoticonParser : NSObject <GGGTextParser>
