...
/**
 The GGGTextViewDelegate protocol defines a set of optional methods you can use
 to receive editing-related messages for GGGTextView objects. 
 ...
 */
@protocol GGGTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(GGGTextView *)textView;
- (BOOL)textViewShouldEndEditing:(GGGTextView *)textView;
- (void)textViewDidBeginEditing:(GGGTextView *)textView;
- (void)textViewDidEndEditing:(GGGTextView *)textView;
- (BOOL)textView:(GGGTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(GGGTextView *)textView;
- (void)textViewDidChangeSelection:(GGGTextView *)textView;

- (BOOL)textView:(GGGTextView *)textView shouldTapHighlight:(GGGTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(GGGTextView *)textView didTapHighlight:(GGGTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(GGGTextView *)textView shouldLongPressHighlight:(GGGTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(GGGTextView *)textView didLongPressHighlight:(GGGTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
...
/**
 The GGGTextView class implements the behavior for a scrollable, multiline text region.
 ...
 * It allows to set an attributed text as placeholder.
 ...
 See NSAttributedString+GGGText.h for more convenience methods to set the attributes.
 See GGGTextAttribute.h and GGGTextLayout.h for more information.
 */
@interface GGGTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<GGGTextViewDelegate> delegate;
...
/**
 The text vertical aligmnent in container. Default is GGGTextVerticalAlignmentTop.
 */
@property (nonatomic) GGGTextVerticalAlignment textVerticalAlignment;
...
/**
 ...
 @discussion It only support the attributes declared in CoreText and GGGTextAttribute.
 See `NSAttributedString+GGGText` for more convenience methods to set the attributes.
 */
...
/**
 ...
 See `GGGTextParser` protocol for more information.
 */
@property (nullable, nonatomic, strong) id<GGGTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) GGGTextLayout *textLayout;
...
/**
 ...
 See `GGGTextLinePositionModifier` protocol for more information.
 */
@property (nullable, nonatomic, copy) id<GGGTextLinePositionModifier> linePositionModifier;

/**
 The debug option to display CoreText layout result.
 The default value is [GGGTextDebugOption sharedDebugOption].
 */
@property (nullable, nonatomic, copy) GGGTextDebugOption *debugOption;
...
@property (nonatomic) IBInspectable GGGTextVerticalAlignment textVerticalAlignment;
...
UIKIT_EXTERN NSString *const GGGTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const GGGTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const GGGTextViewTextDidEndEditingNotification;
