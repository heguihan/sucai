...
/**
 A simple view to diaplay `GGGTextLayout`.
 ...
 */
@interface GGGTextContainerView : UIView
...
@property (nullable, nonatomic, strong) GGGTextLayout *layout;
...
- (void)setLayout:(nullable GGGTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration;
