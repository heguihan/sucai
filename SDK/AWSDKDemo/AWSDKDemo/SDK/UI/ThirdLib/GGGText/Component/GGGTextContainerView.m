...
@implementation GGGTextContainerView {
...
- (void)setLayout:(GGGTextLayout *)layout {
...
- (void)setLayout:(GGGTextLayout *)layout withFadeDuration:(NSTimeInterval)fadeDuration {
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_attachmentChanged) {
        ...
        for (GGGTextAttachment *a in _layout.attachments) {
