...
@protocol GGGTextLinePositionModifier;
 ...
 */
extern const CGSize GGGTextContainerMaxSize;

/**
 The GGGTextContainer class defines a region in which text is laid out.
 GGGTextLayout class uses one or more GGGTextContainer objects to generate layouts.
 
 A GGGTextContainer defines rectangular regions (`size` and `insets`) or 
 ...
 Example:
     ...
     └─────────────────────────────┘
 */
@interface GGGTextContainer : NSObject <NSCoding, NSCopying>
...
/// Creates a container with the specified path. param sizxxxxxex The path.
+ (instancetype)containerWithPath:(nullable UIBezierPath *)path;

/// The constrained size. (if the size is larger than GGGTextContainerMaxSize, it will be clipped)
...
@property GGGTextTruncationType truncationType;
...
@property (nullable, copy) id<GGGTextLinePositionModifier> linePositionModifier;
@end


/**
 The GGGTextLinePositionModifier protocol declares the required method to modify
 the line position in text layout progress. See `GGGTextLinePositionSimpleModifier` for example.
 */
@protocol GGGTextLinePositionModifier <NSObject, NSCopying>
@required
/**
 This method will called before layout is completed. The method should be thread-safe.
 @param lines     An array of GGGTextLine.
 @param text      The full text.
 @param container The layout container.
 */
- (void)modifyLines:(NSArray<GGGTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(GGGTextContainer *)container;
@end


/**
 A simple implementation of `GGGTextLinePositionModifier`. It can fix each line's position
 to a specified value, lets each line of height be the same.
 */
@interface GGGTextLinePositionSimpleModifier : NSObject <GGGTextLinePositionModifier>
...
/**
 GGGTextLayout class is a readonly class stores text layout result.
 ...
 example: (layout with a circle exclusion path)
     ...
     └──────────────────────────┘
 */
@interface GGGTextLayout : NSObject <NSCoding>
...
*/
+ (nullable GGGTextLayout *)layoutWithContainerSize:(CGSize)size text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable GGGTextLayout *)layoutWithContainer:(GGGTextContainer *)container text:(NSAttributedString *)text;
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable GGGTextLayout *)layoutWithContainer:(GGGTextContainer *)container text:(NSAttributedString *)text range:(NSRange)range;

/**
 Generate layouts with the given containers and text.
 
 @param containers An array of GGGTextContainer object (if nil, returns nil).
 @param text       The text (if nil, returns nil).
 @return An array of GGGTextLayout object (the count is same as containers),
    or nil when an error occurs.
 */
+ (nullable NSArray<GGGTextLayout *> *)layoutWithContainers:(NSArray<GGGTextContainer *> *)containers
...
///< The text container
@property (nonatomic, strong, readonly) GGGTextContainer *container;
///< The full text
...
///< Array of `GGGTextLine`, no truncated
@property (nonatomic, strong, readonly) NSArray<GGGTextLine *> *lines;
///< GGGTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) GGGTextLine *truncatedLine;
///< Array of `GGGTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<GGGTextAttachment *> *attachments;
 ...
 */
- (nullable GGGTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable GGGTextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable GGGTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable GGGTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable GGGTextRange *)textRangeByExtendingPosition:(GGGTextPosition *)position;
...
/**
 ...
 @return An array of `GGGTextSelectionRect` objects that encompass the selection.
 If not found, the array is empty.
 */
- (NSArray<GGGTextSelectionRect *> *)selectionRectsForRange:(GGGTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<GGGTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(GGGTextRange *)range;
...
/**
 ...
 @param range An object representing a range in text.
 @return An array of `GGGTextSelectionRect` objects contains the start and end to
 the selection. If not found, the array is empty.
 */
- (NSArray<GGGTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(GGGTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable GGGTextDebugOption *)debug
