...
@interface _GGGTextMagnifierCaret : GGGTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _GGGTextMagnifierCaret
...
- (GGGTextMagnifierType)type {
    return GGGTextMagnifierTypeCaret;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathRef strokePath = CGPathCreateWithEllipseInRect(GGGTextCGRectPixelHalf(rect), NULL);
        ...
        CGContextSaveGState(context); {
            ...
            CGContextSetLineWidth(context, GGGTextCGFloatFromPixel(1));
...
@interface _GGGTextMagnifierRanged : GGGTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _GGGTextMagnifierRanged
#define kMultiple 1.2
#define kSize CGSizeMake(141, 60)
#define kPadding GGGTextCGFloatPixelHalf(6.0)
#define kRadius 6.0
#define kHeight 32.0
#define kArrow 14.0
...
- (GGGTextMagnifierType)type {
    return GGGTextMagnifierTypeRanged;
}
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(arrowPath, NULL, size.width / 2 - kArrow, GGGTextCGFloatPixelFloor(kPadding) + kHeight);
        CGPathAddLineToPoint(arrowPath, NULL, size.width / 2 + kArrow, GGGTextCGFloatPixelFloor(kPadding) + kHeight);
...
@implementation GGGTextMagnifier

+ (id)magnifierWithType:(GGGTextMagnifierType)type {
    switch (type) {
        case GGGTextMagnifierTypeCaret :return [_GGGTextMagnifierCaret new];
        case GGGTextMagnifierTypeRanged :return [_GGGTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[GGGTextMagnifier class]]) {
