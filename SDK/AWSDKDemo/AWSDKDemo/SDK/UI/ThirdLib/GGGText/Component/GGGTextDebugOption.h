...
@class GGGTextDebugOption;

NS_ASSUME_NONNULL_BEGIN

/**
 The GGGTextDebugTarget protocol defines the method a debug target should implement.
 A debug target can be add to the global container to receive the shared debug
 option changed notification.
 */
@protocol GGGTextDebugTarget <NSObject>
 ...
 */
- (void)setDebugOption:(nullable GGGTextDebugOption *)option;
@end



/**
 The debug option for GGGText.
 */
@interface GGGTextDebugOption : NSObject <NSCopying>
 ...
 */
+ (nullable GGGTextDebugOption *)sharedDebugOption;
 ...
 */
+ (void)setSharedDebugOption:(nullable GGGTextDebugOption *)option;
