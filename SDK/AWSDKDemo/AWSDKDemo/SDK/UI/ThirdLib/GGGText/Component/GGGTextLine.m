...
- (void)reloadBounds {
    ...
    for (NSUInteger r = 0; r < runCount; r++) {
        ...
        GGGTextAttachment *attachment = attrs[GGGTextAttachmentAttributeName];
        if (attachment) {
            ...
            NSRange runRange = GGGTextNSRangeFromCFRange(CTRunGetStringRange(run));
...
- (NSString *)description {
    ...
    [desc appendFormat:@"<GGGTextLine: %p> row:%zd range:%tu,%tu",self, self.row, range.location, range.length];
