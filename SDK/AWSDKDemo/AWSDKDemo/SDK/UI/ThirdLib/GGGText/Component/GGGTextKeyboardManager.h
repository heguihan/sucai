...
/**
 ...
 Use -[GGGTextKeyboardManager convertRect:toView:] to convert frame to specified view.
 */
typedef struct {
...
} GGGTextKeyboardTransition;


/**
 The GGGTextKeyboardObserver protocol defines the method you can use
 to receive system keyboard change information.
 */
@protocol GGGTextKeyboardObserver <NSObject>
@optional
...
/**
 A GGGTextKeyboardManager object lets you get the system keyboard information,
 ...
 */
@interface GGGTextKeyboardManager : NSObject
