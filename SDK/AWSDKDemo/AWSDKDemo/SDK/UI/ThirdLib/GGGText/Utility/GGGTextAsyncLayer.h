...
@class GGGTextAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The GGGTextAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface GGGTextAsyncLayer : CALayer
...
/**
 The GGGTextAsyncLayer's delegate protocol. The delegate of the GGGTextAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol GGGTextAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by GGGTextAsyncLayer to render the contents in background queue.
 */
@interface GGGTextAsyncLayerDisplayTask : NSObject
