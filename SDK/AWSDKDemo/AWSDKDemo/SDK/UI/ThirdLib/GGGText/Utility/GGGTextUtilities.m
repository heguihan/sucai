...
NSCharacterSet *GGGTextVerticalFormRotateCharacterSet() {
...
NSCharacterSet *GGGTextVerticalFormRotateAndMoveCharacterSet() {
    static NSMutableCharacterSet *set;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        set = [NSMutableCharacterSet new];
...
CGAffineTransform GGGTextCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]) {
...
CGAffineTransform GGGTextCGAffineTransformGetFromViews(UIView *from, UIView *to) {
    ...
    return GGGTextCGAffineTransformGetFromPoints(before, after);
}
...
UIApplication *GGGTextSharedApplication() {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    return GGGTextIsAppExtension() ? nil : [UIApplication performSelector:@selector(sharedApplication)];
