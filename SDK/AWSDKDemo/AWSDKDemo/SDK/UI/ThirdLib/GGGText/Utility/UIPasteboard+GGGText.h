 ...
 */
@interface UIPasteboard (GGGText)
...
UIKIT_EXTERN NSString *const GGGTextPasteboardTypeAttributedString;

/// The UTI Type identifying WebP data in pasteboard.
UIKIT_EXTERN NSString *const GGGTextUTTypeWEBP;
