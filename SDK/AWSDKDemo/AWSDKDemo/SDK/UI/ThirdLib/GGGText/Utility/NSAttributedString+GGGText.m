...
@interface NSAttributedString_GGGText : NSObject @end
@implementation NSAttributedString_GGGText @end
...
@implementation NSAttributedString (GGGText)

- (NSData *)yy_archiveToData {
    NSData *data = nil;
    @try {
        data = [GGGTextArchiver archivedDataWithRootObject:self];
    }
...
+ (instancetype)yy_unarchiveFromData:(NSData *)data {
    ...
    @try {
        one = [GGGTextUnarchiver unarchiveObjectWithData:data];
    }
    @catch (NSException *exception) {
        AWLog(@"%@",exception);
    }
...
- (GGGTextShadow *)yy_textShadow {
    return [self yy_textShadowAtIndex:0];
}

- (GGGTextShadow *)yy_textShadowAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextShadowAttributeName atIndex:index];
}

- (GGGTextShadow *)yy_textInnerShadow {
    return [self yy_textInnerShadowAtIndex:0];
}

- (GGGTextShadow *)yy_textInnerShadowAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextInnerShadowAttributeName atIndex:index];
}

- (GGGTextDecoration *)yy_textUnderline {
    return [self yy_textUnderlineAtIndex:0];
}

- (GGGTextDecoration *)yy_textUnderlineAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextUnderlineAttributeName atIndex:index];
}

- (GGGTextDecoration *)yy_textStrikethrough {
    return [self yy_textStrikethroughAtIndex:0];
}

- (GGGTextDecoration *)yy_textStrikethroughAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextStrikethroughAttributeName atIndex:index];
}

- (GGGTextBorder *)yy_textBorder {
    return [self yy_textBorderAtIndex:0];
}

- (GGGTextBorder *)yy_textBorderAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextBorderAttributeName atIndex:index];
}

- (GGGTextBorder *)yy_textBackgroundBorder {
    return [self yy_textBackgroundBorderAtIndex:0];
}

- (GGGTextBorder *)yy_textBackgroundBorderAtIndex:(NSUInteger)index {
    return [self yy_attribute:GGGTextBackedStringAttributeName atIndex:index];
}
...
- (CGAffineTransform)yy_textGlyphTransformAtIndex:(NSUInteger)index {
    NSValue *value = [self yy_attribute:GGGTextGlyphTransformAttributeName atIndex:index];
...
- (NSString *)yy_plainTextForRange:(NSRange)range {
    ...
    [self enumerateAttribute:GGGTextBackedStringAttributeName inRange:range options:kNilOptions usingBlock:^(id value, NSRange range, BOOL *stop) {
        GGGTextBackedString *backed = value;
...
+ (NSMutableAttributedString *)yy_attachmentStringWithContent:(id)content
    ...
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc] initWithString:GGGTextAttachmentToken];
    
    GGGTextAttachment *attach = [GGGTextAttachment new];
...
+ (NSMutableAttributedString *)yy_attachmentStringWithContent:(id)content
                                               ...
                                               attachmentSize:(CGSize)attachmentSize
                                                  alignToFont:(UIFont *)font
                                                    alignment:(GGGTextVerticalAlignment)alignment {
    NSMutableAttributedString *atr = [[NSMutableAttributedString alloc] initWithString:GGGTextAttachmentToken];
    ...
    switch (alignment) {
        case GGGTextVerticalAlignmentTop: {
        ...
        case GGGTextVerticalAlignmentCenter: {
        ...
        case GGGTextVerticalAlignmentBottom: {
...
+ (NSMutableAttributedString *)yy_attachmentStringWithEmojiImage:(UIImage *)image
    ...
    if (image.images.count > 1) {
        hasAnim = YES;
    } else if (NSProtocolFromString(@"GGGAnimatedImage") &&
               [image conformsToProtocol:NSProtocolFromString(@"GGGAnimatedImage")]) {
        NSNumber *frameCount = [image valueForKey:@"animatedImageFrameCount"];
        if (frameCount.intValue > 1) hasAnim = YES;
    }
    
    CGFloat ascent = GGGTextEmojiGetAscentWithFontSize(fontSize);
    CGFloat descent = GGGTextEmojiGetDescentWithFontSize(fontSize);
    CGRect bounding = GGGTextEmojiGetGlyphBoundingRectWithFontSize(fontSize);
    ...
    GGGTextAttachment *attachment = [GGGTextAttachment new];
    ...
    if (hasAnim) {
        Class imageClass = NSClassFromString(@"GGGAnimatedImageView");
...
- (BOOL)yy_canDrawWithUIKit {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [failSet addObject:GGGTextShadowAttributeName];
        [failSet addObject:GGGTextInnerShadowAttributeName];
        [failSet addObject:GGGTextUnderlineAttributeName];
        [failSet addObject:GGGTextStrikethroughAttributeName];
        [failSet addObject:GGGTextBorderAttributeName];
        [failSet addObject:GGGTextBackgroundBorderAttributeName];
        [failSet addObject:GGGTextBlockBorderAttributeName];
        [failSet addObject:GGGTextAttachmentAttributeName];
        [failSet addObject:GGGTextHighlightAttributeName];
        [failSet addObject:GGGTextGlyphTransformAttributeName];
    });
...
@implementation NSMutableAttributedString (GGGText)
...
- (void)yy_setTextBackedString:(GGGTextBackedString *)textBackedString range:(NSRange)range {
    [self yy_setAttribute:GGGTextBackedStringAttributeName value:textBackedString range:range];
}

- (void)yy_setTextBinding:(GGGTextBinding *)textBinding range:(NSRange)range {
    [self yy_setAttribute:GGGTextBindingAttributeName value:textBinding range:range];
}

- (void)yy_setTextShadow:(GGGTextShadow *)textShadow range:(NSRange)range {
    [self yy_setAttribute:GGGTextShadowAttributeName value:textShadow range:range];
}

- (void)yy_setTextInnerShadow:(GGGTextShadow *)textInnerShadow range:(NSRange)range {
    [self yy_setAttribute:GGGTextInnerShadowAttributeName value:textInnerShadow range:range];
}

- (void)yy_setTextUnderline:(GGGTextDecoration *)textUnderline range:(NSRange)range {
    [self yy_setAttribute:GGGTextUnderlineAttributeName value:textUnderline range:range];
}

- (void)yy_setTextStrikethrough:(GGGTextDecoration *)textStrikethrough range:(NSRange)range {
    [self yy_setAttribute:GGGTextStrikethroughAttributeName value:textStrikethrough range:range];
}

- (void)yy_setTextBorder:(GGGTextBorder *)textBorder range:(NSRange)range {
    [self yy_setAttribute:GGGTextBorderAttributeName value:textBorder range:range];
}

- (void)yy_setTextBackgroundBorder:(GGGTextBorder *)textBackgroundBorder range:(NSRange)range {
    [self yy_setAttribute:GGGTextBackgroundBorderAttributeName value:textBackgroundBorder range:range];
}

- (void)yy_setTextAttachment:(GGGTextAttachment *)textAttachment range:(NSRange)range {
    [self yy_setAttribute:GGGTextAttachmentAttributeName value:textAttachment range:range];
}

- (void)yy_setTextHighlight:(GGGTextHighlight *)textHighlight range:(NSRange)range {
    [self yy_setAttribute:GGGTextHighlightAttributeName value:textHighlight range:range];
}

- (void)yy_setTextBlockBorder:(GGGTextBorder *)textBlockBorder range:(NSRange)range {
    [self yy_setAttribute:GGGTextBlockBorderAttributeName value:textBlockBorder range:range];
}

- (void)yy_setTextRubyAnnotation:(GGGTextRubyAnnotation *)ruby range:(NSRange)range {
    if (kiOS8Later) {
...
- (void)yy_setTextGlyphTransform:(CGAffineTransform)textGlyphTransform range:(NSRange)range {
    ...
    [self yy_setAttribute:GGGTextGlyphTransformAttributeName value:value range:range];
}
...
- (void)yy_setTextHighlightRange:(NSRange)range
                 ...
                 backgroundColor:(UIColor *)backgroundColor
                       ...
                       tapAction:(GGGTextAction)tapAction
                 longPressAction:(GGGTextAction)longPressAction {
    GGGTextHighlight *highlight = [GGGTextHighlight highlightWithBackgroundColor:backgroundColor];
...
+ (NSArray *)yy_allDiscontinuousAttributeKeys {
    ...
    dispatch_once(&onceToken, ^{
        keys = @[(id)kCTSuperscriptAttributeName,
                 ...
                 GGGTextBackedStringAttributeName,
                 GGGTextBindingAttributeName,
                 GGGTextAttachmentAttributeName].mutableCopy;
        if (kiOS8Later) {
