...
/**
 The GGGLabel class implements a read-only text view.
 ...
 */
@interface GGGLabel : UIView <NSCoding>
...
/**
 The text vertical aligmnent in container. Default is GGGTextVerticalAlignmentCenter.
 */
 ...
 */
@property (nullable, nonatomic, strong) GGGTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) GGGTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) GGGTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) GGGTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil. 
 */
@property (nullable, nonatomic, copy) GGGTextAction highlightLongPressAction;
...
/*
 ...
 3. If you want to get the highest performance, you should do text layout with
    `GGGTextLayout` class in background thread. Here's an example:
    
    GGGLabel *label = [GGGLabel new];
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        GGGTextContainer *container = [GGGTextContainer new];
        container.size = CGSizeMake(100, CGFLOAT_MAX);
        container.maximumNumberOfRows = 0;
        
        // Generate a text layout.
        GGGTextLayout *layout = [GGGTextLayout layoutWithContainer:container text:text];
...
@property (nonatomic) UIEdgeInsets textContainerInset;
@property (nullable, nonatomic, copy) id<GGGTextLinePositionModifier> linePositionModifier;
@property (nonnull, nonatomic, copy) GGGTextDebugOption *debugOption;
@property (nullable, nonatomic, copy) GGGTextAction textTapAction;
@property (nullable, nonatomic, copy) GGGTextAction textLongPressAction;
@property (nullable, nonatomic, copy) GGGTextAction highlightTapAction;
@property (nullable, nonatomic, copy) GGGTextAction highlightLongPressAction;
