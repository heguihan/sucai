...
#define APPLEUSERID @"aiwansigninwithappleuser"

#import "AWAppleLogin.h"

@implementation AWAppleLogin

+(instancetype)shareInstance
{
    static AWAppleLogin *appleLogin = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        appleLogin = [[AWAppleLogin alloc]init];
    });
    return appleLogin;
}
...
//            NSLog(@"str1=%@",str1);
            ...
            [AWHTTPRequest AWAppleLoginRequestWithAppleUser:user token:str1 ifSuccess:^(id  _Nonnull response) {
