...
@protocol DHHanBannerViewDelegate <NSObject>
 ...
 */
- (void)selectImage:(AdLabelView *)bannerView currentImage:(NSInteger)currentImage;

@end//协议结束

@interface AdLab : UILabel
...
/**
 ...
 写在.h文件里的属性 外界可以调用
 */
@property (nonatomic , weak) id <DHHanBannerViewDelegate> delegate;
