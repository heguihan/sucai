...
/**
 ...
 Sample Code:
     ...
     HHFrameImage *image = [HHFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     HGHAnimatedImageView *imageView = [HGHAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface HGHFrameImage : UIImage <HHAnimatedImage>
...
/**
 ...
 @return An initialized HHFrameImage object, or nil when an error occurs.
 */
