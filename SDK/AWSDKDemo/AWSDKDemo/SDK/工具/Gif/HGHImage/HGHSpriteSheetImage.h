...
/**
 ...
 The animation can be played by HGHAnimatedImageView.
 ...
 Sample Code:
    ...
    HHSpriteSheetImage *sprite;
    sprite = [[HHSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    HGHAnimatedImageView *imgView = [HGHAnimatedImageView new];
